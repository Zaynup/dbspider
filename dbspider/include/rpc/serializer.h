...
namespace dbspider::rpc
{
    ...
    public:
        int size() { return m_byteArray->getSize(); }

        // 将偏移设置为0，从头开始读
        void reset() { m_byteArray->setPosition(0); }
        ...
        std::string toString() { return m_byteArray->toString(); }

        ByteArray::ptr getByteArray() { return m_byteArray; }
